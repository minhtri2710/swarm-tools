 ...
 *
 * IMPORTANT: This file must be SELF-CONTAINED with NO imports from opencode-swarm-plugin.
 * The npm package may not be resolvable from ~/.config/opencode/plugin/ context.
 * All swarm detection logic is inlined below.
 *
